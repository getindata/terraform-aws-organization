...
* Import existing AWS organization to the state:
  ...
  ```shell
  $ terragrunt import "module.aws_organization.aws_organizations_organization.this_organizations_organization" o-1234567
  ```
...
* Import existing AWS Organization OU (Organizational Unit)
  ...
  ```shell
  $ terragrunt import "module.aws_organization.module.this_organizational_units[\"test-ou\"].aws_organizations_organizational_unit.this_orgranizations_organizational_unit" ou-abcd-1234567
  ```
...
* Import existing AWS Account that was created in the current AWS Organization
  ...
  ```shell
  $ terragrunt import "module.aws_organization.module.this_organizational_units[\"test-ou\"].module.this_orgranizations_organizational_unit_account[\"test\"].aws_organizations_account.this_organizations_account" 123456789098
  ```
